...
- **CLI 和 API** - 提供命令行工具和 RESTful API 两种使用方式
...
开发指南
添加新的 Action
在 app/core/actions/entities/actions.py 定义 Action 类
在 ACTION_TYPE_MAP 注册
在 app/core/actions/parsing/handler.py 实现 _handle_xxx 方法
添加新的 LLM 提供商
在 app/config/settings.py 添加配置
LiteLLM 自动支持大部分主流模型
